...
import { MapPin, Navigation, Braces, Ticket, Brain } from "lucide-react";

const ITENS_TIMELINE = [
  {
    icone: Navigation,
    cor: "indigo",
    titulo: "Mundo em Grade",
    descricao: "Transformando espaço físico em dados matemáticos.",
  },
  {
    icone: Braces,
    cor: "blue",
    titulo: "Tuplas & Coordenadas",
    descricao: 'A estrutura de dados (x, y) que define "Onde estou?".',
  },
  {
    icone: Ticket,
    cor: "amber",
  ...
  },
  {
    ...
    descricao:
      "Aplicando o mesmo cérebro em problemas totalmente diferentes.",
  },
];
