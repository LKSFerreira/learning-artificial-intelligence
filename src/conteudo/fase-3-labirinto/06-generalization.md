...
Na próxima fronteira, os ambientes ficam grandes demais para a Q-Table caber na memória. Quando isso acontece, precisamos de algo mais poderoso: **redes neurais** como aproximadores. Esse é o território do **Deep Q-Network (DQN)**, que será a próxima fase desta jornada.
