...
Em qualquer jogo: você pode farmar o mesmo mapa que garante XP seguro, ou se aventurar numa dungeon desconhecida que pode conter um tesouro raro, ou mesmo causar a sua derrota em dois golpes.
...
**Política (Policy):** o "manual de decisões" do agente. Dado um estado, qual ação tomar? A política é o resultado final do aprendizado, ou seja, a estratégia consolidada. *"Se vida baixa, usar poção. Se inimigo perto, atacar. Se caminho desconhecido, explorar."*

Na próxima fase, você vai ver isso em ação, manipulando esse equilíbrio com as próprias mãos.
